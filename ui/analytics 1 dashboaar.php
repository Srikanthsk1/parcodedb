...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            // Sales by Category
            // Sales by Category
            // Sales by Category - with error handling
/// Remove the Sales by Category section and replace with Product Wise Sales
...
");
            ...
            //     $category_sales[] = (float) $row['total']; // Ensure numeric value
            // }
            ...
            $select_stats = $pdo->prepare("
                SELECT 
                    ...
                    (SELECT c.category FROM tbl_category c 
                     JOIN tbl_product p ON c.catid = p.category 
                     JOIN tbl_invoice_details id ON p.pid = id.product_id
                     JOIN tbl_invoice i ON id.invoice_id = i.invoice_id
                     WHERE i.order_date BETWEEN :from_date AND :to_date
                     GROUP BY c.category 
